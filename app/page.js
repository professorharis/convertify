    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900">
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
            ...
            <div className="space-y-2 sm:space-y-3 text-center md:text-left">
              ...
              >
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-orange-500 rounded-full flex items-center justify-center text-white">
                  <Layers size={10} className="sm:size-3" />
                </div>
              ...
              {!uploadedFile ? (
                  ...
                  <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg sm:rounded-xl">
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                      {imageFormats.includes(fileName.split('.').pop().toLowerCase()) ? (
                        <img src={previewURL} alt="Preview" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg object-cover flex-shrink-0" />
                      ) : (
                    ...
                    <button onClick={removeUploadedFile} className="p-1 text-gray-500 ml-2 flex-shrink-0">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={removeUploadedFile} className="p-1 text-gray-500">
                      <X size={16} className="sm:size-5" />
                    </button>
                  </div>
          ...
          {/* RIGHT SIDE - Features & Info (animations removed from cards) */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  <Upload size={14} className="sm:size-5" />
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-3 sm:gap-4 text-gray-600 text-xs sm:text-sm">
              <div className="flex items-center gap-1 sm:gap-2">
                <ShieldCheck size={12} className="sm:size-4 text-green-600" />
                <span>100% Secure & Local</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2">
                <Clock size={12} className="sm:size-4 text-blue-600" />
                <span>No Registration</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2">
                <Users size={12} className="sm:size-4 text-purple-600" />
      ...
      <footer className="bg-gray-100 text-gray-800 py-8 sm:py-12 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            ...
            <div>
              <h4 className="font-bold text-sm sm:text-lg mb-3 sm:mb-4">Support</h4>
              <ul className="space-y-1 sm:space-y-2">
                ...
                <li><Link href="/support" className="text-xs sm:text-sm text-gray-600 hover:text-orange-600">Support</Link></li>
              </ul>
            </div>
          </div>
